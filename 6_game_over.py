#1. 모든 공을 없애거나, 캐릭터가 공에 닿거나 ,시간제한 99초 초과시 
    ...
    #공 rect 정보 업데이트
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                #가장 작은 크기의 공이 아니라면 다음 단계의 공으로 나눠주는 처리
                if ball_img_idx < 3:
                    #현재 공 크기 정보를 가지고 옴
                ...
                #왼쪽으로 튕겨나가는 공
                    ...
                    "img_idx":ball_img_idx + 1, #공의 이미지의 인덱스
                    "to_x" :-3, #공의 x축 이동방향
                    "to_y" :-6, #y축 이동방향 ,
        ...
        break #안쪽 for문에서 break를 만나면 여기로 진입 가능 2중 for 문을 한번
